export const ChromeSVG = (props: React.HTMLAttributes<SVGElement>) => (
  <svg
    width="24"
    height="24"
    viewBox="0 0 24 24"
  ...
  >
    <g id="chrome">
      <g id="Icon">
        ...
        <circle cx="24" cy="23.9947" r="12" fill="#fff" transform="scale(0.5)" />
        <path
          transform="scale(0.5)"
        ...
        <path
          ...
          fill="url(#a)" />
        <circle cx="24" cy="24" r="9.5" fill="#1a73e8" transform="scale(0.5)" />
        <path
          transform="scale(0.5)"
