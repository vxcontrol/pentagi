...
type Subtask struct {
	...
	Status      SubtaskStatus `form:"status" json:"status" validate:"oneof=created running waiting finished failed,required" gorm:"type:SUBTASK_STATUS;NOT NULL;default:'created'"`
