...
type SearchGuideAction struct {
	...
	Message   string   `json:"message" jsonschema:"required,title=User-Facing Guide Search Message" jsonschema_description:"A concise summary of your queries and the type of guide needed, to be presented to the user in English. This message should guide the user toward their goal in a clear and approachable manner."`
}
...
type SearchAnswerAction struct {
	...
	Message   string   `json:"message" jsonschema:"required,title=User-Facing Answer Search Message" jsonschema_description:"A concise summary of your queries and the type of answer needed, to be presented to the user in English. This message should guide the user toward their goal in a clear and approachable manner."`
}
